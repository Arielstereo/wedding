  ...
  return (
    <header className="relative w-full h-screen">
      <div className={`${title.className} antialiased absolute top-1/4 left-12 md:left-32 z-20 flex flex-col gap-1 text-yellow-500 text-6xl md:text-8xl text-center`}>
        ...
        <span className="animate__animated animate__backInUp">Julieta</span>
      <div className="mt-6">
      ...
      <div className="flex justify-center items-center gap-4 mt-6 text-2xl md:text-3xl text-white animate-pulse">
        <span className="bg-slate-800 rounded-lg p-2">20</span>
        <span className="bg-slate-800 rounded-lg p-2">05</span>
        <span className="bg-slate-800 rounded-lg p-2">2025</span>
      </div>
      </div>
